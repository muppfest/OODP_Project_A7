...
public class ShowProgramCourse extends JPanel implements IShowPanel<Course> {
	...
	public ShowProgramCourse(Course course, ProgramView programView) {
		super();
		...
		showMomentsButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				//programView.listMoments(course.getCourseId());
			}
		});
	...
	public void save() {
		...
		try {
			...
			JOptionPane.showMessageDialog(programView, "Felaktig URL");
			e.printStackTrace();
		}
